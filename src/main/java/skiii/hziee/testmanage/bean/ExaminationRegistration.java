...
@Data
public class ExaminationRegistration{
    private int id;
    ...
    public ExaminationRegistration() {

    }

    public ExaminationRegistration(int id,Integer test_id, String test_name, Integer now_num, Integer max_num, Date begin_time, Date end_time, String place, String owner) {
        this.id = id;
